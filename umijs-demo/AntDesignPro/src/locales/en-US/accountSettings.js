export default {
  ...
  'account-settings.basic.geographic.province-message': 'Please input your province!',
  'account-settings.basic.geographic.city-message': 'Please input your city!',
  ...
  'account-settings.basic.update.fail': 'Update basic information failed',
  ...
  'account-settings.security.no-password-description': 'Password is not set',
  'account-settings.security.phone': 'Security Phone',
  'account-settings.security.phone-description': 'Bound phone：',
  'account-settings.security.no-phone-description': 'Phone is not bound',
  'account-settings.security.question': 'Security Question',
  'account-settings.security.question-description': 'The security question is set',
  'account-settings.security.no-question-description':
      'The security question is not set, and the security policy can effectively protect the account security',
  'account-settings.security.email': 'Bound Email',
  'account-settings.security.email-description': 'Bound Email：',
  'account-settings.security.no-email-description': 'Email is not bound',
