...
class Login extends Component {
  ...
  renderMoreLoginActions = autoLogin => {
    return (
      <div>
  ...
  render() {
    ...
    return (
      <div className={styles.main}>
        <LoginComponents defaultActiveKey={type}
        ...
        >
          ...
          {this.renderMoreLoginActions.call(this, autoLogin)}
          <Submit loading={submitting}>
            <FormattedMessage id="user-login.login.login" />
          </Submit>
          {this.renderNoAccountActions()}
        </LoginComponents>
      </div>
    );
  }
